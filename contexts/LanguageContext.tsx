...
const enStrings: { [key: string]: string } = {
  ...
  "trainerSignup_successSubtitle": "Your trainer profile has been created successfully.",
  "trainerSignup_successInfo": "Clients can now find and book sessions with you. We're excited to have you on the FASTA platform.",
  "trainerSignup_successButton": "See Your Profile",
  ...
  "paymentModal_card_numberLabel": "Card Details",
  ...
  "paymentModal_submitButton_bit_confirm": "I have completed the payment",
