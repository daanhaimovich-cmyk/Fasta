...
import { TargetIcon, BriefcaseIcon } from './IconComponents';
...
const RoleSelection: FC<RoleSelectionProps> = ({ onSelectRole }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto text-center animate-fade-in-down">
      <h1 data-design-id="role-selection-title" className="text-3xl md:text-4xl font-bold text-white mb-4">
        {t('roleSelection_title')}
      </h1>
      <p data-design-id="role-selection-subtitle" className="text-slate-400 mb-12 max-w-xl mx-auto">
        {t('roleSelection_subtitle')}
      </p>
      <div className="grid md:grid-cols-2 gap-8">
        <button
          data-design-id="role-selection-client-button"
        ...
        <button
          data-design-id="role-selection-trainer-button"
